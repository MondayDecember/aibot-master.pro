...
BASE_SYSTEM_PROMPT = (
    ...
    "Whenever you write code, in ANY language, you MUST add a short comment "
    "on every function and every non-obvious line, directly in the code "
    "itself - never rely on prose written after the code block to explain "
    "it, and never skip comments just because a snippet looks simple. "
    ...
    "            return False\n"
    "    return True\n"
    "Match that density of comments in every piece of code you write, "
