...
SETTINGS = [
    ...
    ("OCR_ENABLED", "Распознавать текст на фото (OCR)", "bool",
     "Tesseract на CPU: читает текст со скринов/документов перед vision-моделью."),
    ("COMMENT_ON_FORWARDS", "Комментировать пересланное", "bool",
     "На пересланные новости/сообщения/голосовые бот даёт свой комментарий, а не описание."),
