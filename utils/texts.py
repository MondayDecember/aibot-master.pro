...
Style note: every status/prompt/confirmation/error line gets an emoji icon
so the chat reads consistently. Only emoji are added freely - HTML tags
(<b>/<i>/<code>) are added only to strings already known to render with
parse_mode=HTML; several keys here are also sent via callback.answer() or
with parse_mode=None (e.g. rate_limited, admin_alert, reminder_fire), where
HTML tags would show up as literal text, so those stay tag-free.
"""
import contextvars
...
_TEXTS = {
    "en": {
        "start": (
            "👋 Hello! I'm your AI assistant. Send me text, voice messages, photos, "
        ...
        "unknown_persona": "⚠️ Unknown persona",
        ...
        "generating": "<i>✍️ Generating response...</i>",
        ...
        "voice_unavailable": "⚠️ Voice transcription is currently unavailable (model not loaded).",
        "voice_error": "⚠️ Error processing voice message: {error}",
        "voice_empty": "⚠️ Couldn't recognize any speech in the voice message.",
        "reading_document": "<i>📄 Reading document...</i>",
        "doc_default_caption": "Summarize this document.",
        "doc_too_large": "⚠️ The file is too large - telegram bots can only download files up to 20 MB.",
        "doc_unsupported": (
            "⚠️ Unsupported file type. Send a PDF, a Word .docx, or a plain-text "
            "file (.txt, .md, .csv, code files etc.)."
        ),
        "doc_download_failed": "⚠️ Sorry, failed to download the file from telegram.",
        "doc_unreadable": "⚠️ Sorry, couldn't read this file - it may be corrupted.",
        "doc_no_text": (
            "⚠️ Couldn't extract any text from this file. If it's a scanned PDF, "
            "it contains images instead of text - try sending pages as photos."
        ),
        "doc_truncated": "\n\n[ℹ️ The document is too long for my context window ({n} chars) - showing excerpts from the beginning, middle, and end rather than the whole thing]",
        "error_generic": "⚠️ Sorry, I encountered an error processing your request.",
        "llm_unavailable": "⚠️ I'm sorry, I couldn't process that request at the moment.",
        "empty_response": "⚠️ The model returned an empty response.",
        ...
        "remind_parse_failed": (
            "⚠️ Couldn't figure out when to remind you. Say the time explicitly, "
        ...
        "persona_coder": "💻 Coder",
        "tokens_footer": "🔢 {prompt}+{completion}={total} tokens",
        "code_attached": "📎 Code attached as a file below (too long for one message).",
        ...
        "image_gen_unavailable": (
            "⚠️ Image generation isn't set up - see imagegen/README.md. "
            "It runs as a separate local service, not part of the bot itself."
        ),
        "image_gen_failed": "⚠️ Sorry, image generation failed - the imagegen service may not be running.",
        ...
        "regen_none": "⚠️ Nothing to regenerate - send a new message.",
        "stopping": "⏹ Stopping...",
    },
    "ru": {
        "start": (
        ...
        "thinking": "<i>💭 Думаю...</i>",
        "generating": "<i>✍️ Генерирую ответ...</i>",
        ...
        "voice_unavailable": "⚠️ Распознавание речи сейчас недоступно (модель не загружена).",
        "voice_error": "⚠️ Ошибка обработки голосового сообщения: {error}",
        "voice_empty": "⚠️ Не удалось распознать речь в голосовом сообщении.",
        "reading_document": "<i>📄 Читаю документ...</i>",
        "doc_default_caption": "Кратко перескажи этот документ.",
        "doc_too_large": "⚠️ Файл слишком большой — Telegram позволяет ботам скачивать файлы до 20 МБ.",
        "doc_unsupported": (
            "⚠️ Неподдерживаемый тип файла. Пришлите PDF, документ Word .docx "
            "или текстовый файл (.txt, .md, .csv, файлы кода и т.п.)."
        ),
        "doc_download_failed": "⚠️ Не удалось скачать файл из Telegram.",
        "doc_unreadable": "⚠️ Не удалось прочитать файл — возможно, он повреждён.",
        "doc_no_text": (
            "⚠️ В файле не нашлось текста. Если это сканированный PDF, в нём картинки "
            "вместо текста — попробуйте прислать страницы как фото."
        ),
        "doc_truncated": "\n\n[ℹ️ Документ длиннее, чем позволяет контекст модели ({n} симв.) - показаны отрывки из начала, середины и конца, а не целиком]",
        "error_generic": "⚠️ Извините, при обработке запроса произошла ошибка.",
        "llm_unavailable": "⚠️ Извините, сейчас не получилось обработать запрос.",
        "empty_response": "⚠️ Модель вернула пустой ответ.",
        ...
        "remind_parse_failed": (
            "⚠️ Не понял, когда напомнить. Скажите время явно, например: "
        ...
        "persona_coder": "💻 Программист",
        "tokens_footer": "🔢 {prompt}+{completion}={total} токенов",
        "code_attached": "📎 Код прикреплён файлом ниже (не поместился в одно сообщение).",
        ...
        "image_gen_unavailable": (
            "⚠️ Генерация картинок не настроена — см. imagegen/README.md. "
            "Это отдельный локальный сервис, не часть самого бота."
        ),
        "image_gen_failed": "⚠️ Не удалось сгенерировать картинку — возможно, сервис imagegen сейчас не запущен.",
        ...
        "regen_none": "⚠️ Нечего перегенерировать — отправьте новое сообщение.",
